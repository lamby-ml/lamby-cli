...
def clone(project_id):
    ...
    # fs.upload_file("models/1be03de7f8015b1cc147474f4ef324ea856c2f38b4d166733307d7af655ba76a","projectid")
    # fs.upload_file("models/27b3ce6beed68344e9302cdf0533a4771e38bca28f371241c88053f1e34cbd2c","projectid")
    # fs.upload_file("models/2854e3531d865d258ae913871a2eb4fcb93d291a0dea74e80bce0a7685e07585","projectid")
    # fs.upload_file("models/2e7093a0d9181d0b37394327798e5e3eb51da69b74b697e472027286d1b6505c","projectid")
    # fs.upload_file("models/80a274cab187934333647e7640c2e477d98e246994a042c0931346ee005a732e","projectid")
    # fs.upload_file("models/9824ed34e110a0ff5f9ff4f3957edba82610c45af5d5b9f64763c4130707d7b4","projectid")
    # fs.upload_file("models/ac76aae9fc7234b441d006175d9c24100d0e5a769ebd96c4335fe81309636b87","projectid")
    # fs.upload_file("models/b67b1f0049f234031470f0558b8957d94113a593fbba3c7b072176b892bfb004","projectid")
    # fs.upload_file("models/c1315939f8727c68bfd23f2060fe094ec6a82fc607efaef96c547492c2361567","projectid")
    ...
    try:
        # print("LOOOOOOOL")
        res = requests.get(os.getenv('LAMBY_WEB_URI'),'/api/projects/{}'.format(project_id))
        res = res.getjson() ##verify this method
    ...
    for commit_id in commit_ids:
        filename = str(project_name+"/"+commit_id)
        click.echo("Importing: {}".format(commit_id))
        fs.download_file_from_key("{}/{}".format(project_id, commit_id), commit_id)
